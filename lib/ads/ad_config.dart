...
class AdConfig {
  ...
  static const String bannerAdUnitIdIos =
      'ca-app-pub-1133915836610707/2846888989';

  static String get bannerAdUnitId =>
      Platform.isAndroid ? bannerAdUnitIdAndroid : bannerAdUnitIdIos;

  /// App Open ad unit ID for Android. Test: ca-app-pub-3940256099942544/9257395921
  static const String appOpenAdUnitIdAndroid =
      'ca-app-pub-1133915836610707/9879635969';

  /// App Open ad unit ID for iOS.
  static const String appOpenAdUnitIdIos =
      'ca-app-pub-1133915836610707/9227640091';

  static String get appOpenAdUnitId =>
      Platform.isAndroid ? appOpenAdUnitIdAndroid : appOpenAdUnitIdIos;
}
